...
const Model = () => {
    ...
    useEffect(()=>{
        if(size === 'large'){
            animateWithGsapTimeLine(tl, small , smallRotaion, '#view1','#view2',{transform:'translateX(-100%)',duration:2})

        }
        if(size === 'small'){
            animateWithGsapTimeLine(tl, large , largeRotaion, '#view2','#view1',{transform:'translateX(0)',duration:2})
        }
    },[size])
